/***
*
*   Copyright (c) 2023, V4 Games, All Rights Reserved.
*
****/

#ifndef DEMO
	#define FULLENGINENAME		"Blade"
	#define GAME_SHORTNAME		"BLD"
	#define GAME_BASEGAMES		"platform","blade"
	#define GAME_PROTOCOL		"Blade"
#else
	#define FULLENGINENAME		"Blade Demo"
	#define GAME_SHORTNAME		"BLDDemo"
	#define GAME_BASEGAMES		"platform","demobld"
	#define GAME_PROTOCOL		"BLD-Demo"
#endif

// #define BRANDING_ICON "fteqw.ico"
#define DISTRIBUTION "V4G"
#define DISTRIBUTIONLONG "V4 Games"
